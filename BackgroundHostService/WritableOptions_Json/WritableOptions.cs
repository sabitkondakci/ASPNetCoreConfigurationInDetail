...
namespace WritableOptions_Json
{
    public class WritableOptions<T> : 
        IWritableOptions<T> where T : class, new()
    {
        ...
        public void Update(Action<T> applyChanges)
        {
            ...
            var sectionObject = jObject.TryGetValue(_section,
                out JToken section) ? 
            ...
            jObject[_section] = JObject.
                Parse(JsonConvert.SerializeObject(sectionObject));
    ...
    public static class ServiceCollectionExtensions
    {
                ...
                string file = "appsettings.json") where T : class, new()
        {
            ...
            services.AddTransient<IWritableOptions<T>>(provider =>
            {
                ...
                return new WritableOptions<T>(environment,
                    options, section.Key, file);
            });
        }
    }
}
